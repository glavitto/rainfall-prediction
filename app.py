...
def main():
    page = st.sidebar.selectbox("Choose a page", ["Home", "Predict Rainfall", "About"])
    ...
    if page == "Home":
        ...
        st.write("""
        This application uses a machine learning model to predict whether it will rain in Australia based on various weather parameters. 
